...
const team = [
  {
    name: '木崎 有貴',
    nameEn: 'Yutaka Kizaki',
    role: 'Creative Director',
description: 'ブランド戦略の立案からクリエイティブの統括まで一貫して担い、コンセプト設計からアウトプットまでを横断的にディレクション。\n\n単なるビジュアル制作にとどまらず、「誰に・何を・どう感じてほしいか」という本質的な設計思想を軸に、ブランドの価値を最大化するクリエイティブを追求しています。\n\nこれまで、Webサイト、LP、広告クリエイティブ、SNSコンテンツなど幅広い領域に携わり、CTR・CVR・CPAといった成果指標をもとに改善を繰り返すことで、見た目の美しさだけでなく“結果につながるデザイン”を実現してきました。\n\nクライアントの「想い」や背景にあるストーリーを丁寧に汲み取り、それをユーザーに自然と伝わる形へと翻訳することを大切にしています。\n\n感覚やセンスに頼るのではなく、戦略とロジックに裏打ちされたクリエイティブによって、ブランドとユーザーの最適な接点を設計します。\n\nまた、制作プロセスにおいては、設計意図と成果を構造化し、再現性のあるナレッジとして蓄積することにも注力。チーム全体のクリエイティブ品質向上にも貢献しています。',  },
  {
    name: 'つかさ',
    nameEn: 'Tsukasa',
    role: 'Art Director & Designer',
  description: `アートディレクター／デザイナーとして、ビジュアルデザインを軸にWebサイトの設計から制作までを一貫して担当。単なる見た目の美しさにとどまらず、ブランドの世界観や空気感を丁寧に表現し、ユーザーの感情に自然と響くデザインを追求しています。

レイアウト、タイポグラフィ、配色、余白設計といった細部にまで徹底してこだわり、視認性と美しさを高い次元で両立。情報を正しく伝えるだけでなく、「見ていて心地よい」「思わず触れたくなる」体験設計を大切にしています。

また、コンセプトやブランドトーンに基づいたビジュアル設計を行うことで、プロジェクト全体のクオリティを底上げ。ディレクターやエンジニアと密に連携しながら、意図を持ったデザインを形にし、完成度の高いアウトプットへと昇華させます。
              ...
              <div className="relative aspect-square rounded-2xl overflow-hidden bg-card border border-border">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <p className="text-8xl sm:text-9xl font-bold text-foreground/5">Junk</p>
                    <p className="text-xs sm:text-sm text-muted-foreground mt-4 uppercase tracking-widest">Branding Studio</p>
                  </div>
                </div>
              </div>
            </SectionReveal>
              ...
              <SectionReveal key={member.name} delay={0.3 + index * 0.15}>
                <div className="group">
                  <div className="relative aspect-[3/4] mb-6 sm:mb-8 rounded-2xl overflow-hidden bg-card border border-border">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-6xl sm:text-7xl md:text-8xl font-bold text-foreground/5">
